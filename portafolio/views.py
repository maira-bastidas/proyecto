...
class menu(View):
    template_name = 'portafolio/menu.html'

    def get(self, request, *args, **kwargs):
        categoria = Categoria.objects.all()
        return render(request, self.template_name, {'productos':categoria})

class inicio(View):
    template_name = 'portafolio/pollos.html'
...
class producto(View):
    template_name = 'portafolio/producto.html'
